...
interface GeneralAIAssistantProps {
  onBack: () => void;
}
...
const GeneralAIAssistant: React.FC<GeneralAIAssistantProps> = ({ onBack }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'assistant',
      content: "Hello, Dungeon Master! I'm your General AI Assistant powered by ChatGPT. I can help you with world building, creating NPCs, developing plot hooks, generating locations, and answering D&D rules questions. Customize the settings above to get more tailored suggestions, then choose a quick prompt or ask me anything!",
      timestamp: new Date()
    }
  ]);
      ...
      <header className="bg-gradient-to-r from-amber-800 to-orange-800 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4 flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">General AI Assistant</h1>
